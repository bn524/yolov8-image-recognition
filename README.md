<<<<<<< HEAD
# YOLOv8 图像识别系统 - Vue + Vite 版本

## 📋 项目简介

**YOLOv8 智能图像识别系统**是一个基于深度学习的前后端分离Web应用，使用 Vue + Vite 构建。用户可以通过网页上传图片，系统会自动识别图片中的物体并用方框标记出来。
=======
# YOLOv8 图像识别系统 - Vue3 + Vite 版本

## 📋 项目简介

**YOLOv8 智能图像识别系统**是一个基于深度学习的前后端分离Web应用，使用 Vue3 + Vite 构建。用户可以通过网页上传图片，系统会自动识别图片中的物体并用方框标记出来。
>>>>>>> a98a79d845dfb9a680ca9800e8665abf7d029a20
...
### 前端技术
- **框架**: Vue 3.x (使用 @vitejs/plugin-vue3)
- **构建工具**: Vite (现代前端构建工具)
- **UI组件库**: Element UI
- **HTTP请求**: Axios
- **样式**: CSS3 + 现代布局技术
